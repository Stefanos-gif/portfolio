...
return {
	...
	_: {
		...
		prerendered_routes: new Set(["/","/about","/background","/projects/ai-pro","/projects/barbershop-website","/projects/cpp-games","/projects/cpp-lvl3","/projects/data-analysis-with-pandas","/projects/flask-web-app","/projects/meteor","/projects/python-web-scraper","/projects/satfire","/projects/taskmanager","/projects/thalasat","/projects/watchlist-app"]),
		matchers: async () => {
