...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div id="container" class="svelte-1gix4lf" data-svelte-h="svelte-5asjy2"><h1 class="svelte-1gix4lf">Data Analysis with Pandas</h1> <p id="first-p" class="svelte-1gix4lf">This <a href="https://github.com/Stefanos-gif/data-analysis-with-pandas" target="_blank" rel="noopener noreferrer" style="color: #2eff23;">project</a> performs data analysis on a dataset using Pandas and creates a histogram of a specified column.</p></div> <div id="features" class="svelte-1gix4lf" data-svelte-h="svelte-he86kd"><h2 class="svelte-1gix4lf">Description</h2> <p class="svelte-1gix4lf">This project harnesses Pandas to explore and analyze a dataset and generate a histogram for a designated column.</p> <h3 class="svelte-1gix4lf">Technologies Used</h3> <ul class="svelte-1gix4lf"><li><strong>Pandas</strong> - A powerful data manipulation and analysis library for Python.</li> <li><strong>Python</strong> - A versatile programming language used for backend development.</li> <li><strong>Matplotlib</strong> - A plotting library for the Python programming language and its numerical mathematics extension NumPy.</li></ul></div> <div id="img-container" style="cursor: pointer;" class="svelte-1gix4lf">${validate_component(TripleImage, "TripleImage").$$render(
    $$result,
    {
