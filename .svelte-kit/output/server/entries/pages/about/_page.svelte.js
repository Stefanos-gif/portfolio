...
function Accivmnets($$payload) {
  $$payload.out.push(`<div id="achivment-container" class="svelte-jk4tjo"><section class="card svelte-jk4tjo"><h2 class="svelte-jk4tjo">Achievements</h2> <img src="/paint.jpg" alt="Creative project collage" class="svelte-jk4tjo"/> <ul class="svelte-jk4tjo"><li class="svelte-jk4tjo"><b>Completed 50 Programming Projects:</b> 33 public GitHub repositories and 20+ small apps/scripts across multiple stacks.</li> <li class="svelte-jk4tjo"><b>Hackathon Winner — Cassini Camp (Cyprus):</b> Core member of <em>SSATfire</em>, 1st place for an innovative space-data solution.</li> <li class="svelte-jk4tjo"><b>Champion — Venetostars 2025:</b> With <em>Team Thalassat</em>, delivered rapid prototyping and seamless teamwork.</li> <li class="svelte-jk4tjo"><b>STEM &amp; Robotics Mentor:</b> Tutored C++ and robotics fundamentals through hands-on projects.</li></ul></section> <section class="card svelte-jk4tjo"><h2 class="svelte-jk4tjo">Strengths</h2> <img src="/write.png" alt="Notes and planning" class="svelte-jk4tjo"/> <ul class="svelte-jk4tjo"><li class="svelte-jk4tjo"><b>Polyglot &amp; Full-Stack:</b> `);
  ...
  $$payload.out.push(`<!---->), Lua; Node.js, React, SvelteKit.</li> <li class="svelte-jk4tjo"><b>Ethical Hacking:</b> Practical security mindset: assessment, hardening, best practices.</li> <li class="svelte-jk4tjo"><b>Analytical Problem-Solving:</b> Break down complexity, design clean solutions, execute.</li> <li class="svelte-jk4tjo"><b>Clear Communication:</b> Teach and explain technical ideas to any audience.</li> <li class="svelte-jk4tjo"><b>Adaptability:</b> Learn tools fast; stay current with modern stacks.</li></ul></section> <section class="card svelte-jk4tjo"><h2 class="svelte-jk4tjo">Goals</h2> <img src="/comp.png" alt="Computing and engineering goals" class="svelte-jk4tjo"/> <ul class="svelte-jk4tjo"><li class="svelte-jk4tjo"><b>Advance in Electrical Engineering</b> with hands-on experience.</li> <li class="svelte-jk4tjo"><b>Go to MIT</b> to push research and impact.</li> <li class="svelte-jk4tjo"><b>Contribute to real projects</b> with measurable outcomes.</li> <li class="svelte-jk4tjo"><b>Expand mentoring</b> for the next generation of builders.</li> <li class="svelte-jk4tjo"><b>Build innovative robots &amp; software</b> that solve real problems.</li></ul></section></div>`);
}
function _page($$payload) {
  ...
  $$payload.out.push(`<section id="container" class="svelte-2bl0qe"><div id="about" class="svelte-2bl0qe"><h1 class="svelte-2bl0qe">About Me</h1> <p class="svelte-2bl0qe">Hi, I'm Stefanos Siathas—a computer scientist working at EDU Bridge Tech Innovation LTD and tutoring at Stemfreak. I enjoy the gym, martial arts, and helping others grow in tech. I work with Python, C++, JavaScript, C#, Lua, TypeScript, and SvelteKit. <br/><br/> <b>Check me out:</b> <a href="https://github.com/Stefanos-gif" target="_blank" rel="noopener" style="color:#a782ff;">GitHub</a>  |  <span style="font-weight:600;">Contact me:</span> <button type="button" class="email-link" style="background:none;border:none;padding:0;margin:0;cursor:pointer;color:#a782ff;font:inherit;" title="Click to copy email" aria-label="Copy email to clipboard">stefanossiathas@gmail.com</button> `);
  {
    $$payload.out.push("<!--[!-->");
  }
