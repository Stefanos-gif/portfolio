...
<style>
  ...
  .projects-toggle {
    ...
    width:48px; height:100%; border-radius:10px; cursor:pointer;
  ...
  .sheet {
    width:min(420px,90vw); border-radius:22px;
  ...
  .sheet-header h3{ margin:0; font-size:1.25rem; font-weight:800; letter-spacing:.02em; color:var(--text); text-shadow:0 0 10px rgba(123,47,242,.7); }
  ...
  @media (max-width:420px) {
    ...
    .sheet-list a{ font-size:1.06rem; padding:1rem 1.1rem; }
  }
